...
func TestReElection2A(t *testing.T) {
	...
	cfg.begin("Prepare to disconnect leader1")
	...
	// be elected.
	cfg.begin("start disconnect the second leader")
	...
	cfg.begin("start reconnect one point")
	cfg.connect((leader2 + 1) % servers)
	cfg.checkOneLeader()
	cfg.begin("start reconnect another point")
